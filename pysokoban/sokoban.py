...
def nilangshu():
    ...
    class AboutDialog(tk.Frame):
        def __init__(self, master=None):
            ...
            self = tk.Toplevel()
            self.title("Game Ke BAREMAY JANIE")
    ...
    class CompleteDialog(tk.Frame):
        def __init__(self, master=None):
            ...
            info = tk.Label(self, text=("You Want To play Again Then Restert It With Same Process"))
            info.grid(row=0)
